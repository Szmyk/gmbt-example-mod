...
func void DIA_Fingers_BecomeShadow_TeachMe()
{
	...
	AI_Output (self, other,"DIA_Fingers_BecomeShadow_TeachMe_05_04"); //If you want to join the Camp, it's an advantage to be a good fighter or thief.
...
{
	AI_Output (other, self,"DIA_Fingers_Lehrer_Schleichen_15_00"); //I want to learn how to sneak around.
	...
	AI_Output (self, other,"DIA_Fingers_Lehrer_Schleichen_05_02"); //But when it comes to teaching how to sneakaround, Cavalorn is the better man for you!
...
{
	AI_Output (other, self,"DIA_Fingers_Lehrer_PICKPOCKET_15_00"); //I want to become a skilled pickpocket!
...
FUNC VOID DIA_Fingers_Learnt_Info()
{
	...
	else
	{
		...
		AI_Output (self, other,"DIA_Fingers_Learnt_05_06"); //Learn a thief's skill! You need to become more skilled in sneaking, pickpocketing or opening locks. Then you'll have my vote.
