...
FUNC void  GUR_1202_CorAngar_ZWEIHAND2_Info()
{
	...
	if (B_GiveSkill(other,NPC_TALENT_2H , 2, LPCOST_TALENT_2H_2))
	{
		...
		AI_Output			(self, other,"GUR_1202_CorAngar_ZWEIHAND2_Info_08_07"); //Remain calm. Only if you enter a fight calmly and with concentration, will you will survive it.
...
{	
	...
	AI_Output			(self, other,"Info_CorAngar_FindHerb_Success_08_05"); //All we can do now is hope that it is not too late for Y'Berion.
	...
	AI_Output			(self, other,"GUR_1202_CorAngar_DEATH_Info_08_09"); //I believe he left the book and focus in his laboratory. Here is the key to the chest.
