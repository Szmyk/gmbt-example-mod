...
FUNC VOID DIA_Wolf_Hello_Info()
{
	...
	AI_Output			(self, other,"DIA_Wolf_Hello_09_01"); //I'm Wolf. I make armors.
...
FUNC VOID DIA_Wolf_SellArmor_Info()
{
	...
	{
		AI_Output (self, other,"DIA_Wolf_SellArmor_09_01"); //Since you are one of us now, I can sell you one.
...
func VOID Info_Wolf_SPEAK_Info()
{
	...
	AI_Output 			(self,hero,"Info_Wolf_SPEAK_09_08"); //If you could bring me some of these armor plates, I could try to make an armor from them.
};
...
func VOID Info_Wolf_ARMORINWORK_Info()
{
	...
	AI_Output 			(self,hero,"Info_Wolf_ARMORINWORK_09_02"); //It's going to take some time, man! Those plates are really heavy stuff. I still haven't found a way yet to fix them together!
	AI_Output 			(self,hero,"Info_Wolf_ARMORINWORK_09_03"); //Give me some more time, I'll get there!
	AI_StopProcessInfos	(self);
};
