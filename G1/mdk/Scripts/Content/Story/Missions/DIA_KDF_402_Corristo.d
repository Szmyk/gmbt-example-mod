...
FUNC void  KDF_402_Corristo_EXPLAINMAGE_Info()
{
	...
	AI_Output (self, other,"KDF_402_Corristo_EXPLAINMAGE_Info_14_03"); //Our magic is a gift from the gods. We have been chosen to act as priests, tutors and judges.
...
func void  KDF_402_Corristo_WANNBEKDF_Info()
{
	...
	if	(hero.level < 10)
	{
		AI_Output (self, other,"KDF_402_Corristo_WANNBEKDF_Info_14_04"); //You haven't learned enough yet. Come back to me when you have learned more.
	...
	{
		AI_Output (self, other,"KDF_402_Corristo_WANNBEKDF_Info_14_03"); //Many have wanted to join us, but throughout the years I have taken only one as my apprentice. All the others have failed.
		AI_Output (self, other,"KDF_402_Corristo_WANNBEKDF_Info_14_05"); //Your spirit is mature and ready to join us. If you want to become a magician, I must test you first. Let me know when you are ready for the test.
...
FUNC VOID  KDF_402_Corristo_KDFTEST_SLEEPER()
{
	...
	AI_Output (self, other,"KDF_402_Corristo_KDFTEST_SLEEPER_Info_14_03"); //Looks like you've been spending too much time among the swamp brothers. Maybe you had better stay there.
	AI_StopProcessInfos	( self );
	Npc_ExchangeRoutine (self,"START");
};
...
func void  KDF_402_Corristo_EXPLAINCIRCLES_Info()
{
	...
	AI_Output (self, other,"KDF_402_Corristo_EXPLAINCIRCLES_Info_14_05"); //Many hours of learning are required and you will need much experience to reach the higher Circles.
	...
	AI_Output (self, other,"KDF_402_Corristo_EXPLAINCIRCLES_Info_14_07"); //They are part of your life. They will always be with you. Make them a part of you.
...
FUNC void  KDF_402_Corristo_KREIS1_Info()
{
	...
	if (B_GiveSkill(other,NPC_TALENT_MAGE , 1, LPCOST_TALENT_MAGE_1))
	{
		...
		AI_Output (self, other,"KDF_402_Corristo_KREIS1_Info_14_04"); //By using your own magic powers, you will be able to cast the magic of the rune.
...
FUNC void  KDF_402_Corristo_KREIS2_Info()
{
	...
	if (B_GiveSkill(other,NPC_TALENT_MAGE , 2, LPCOST_TALENT_MAGE_2))
	{
		...
		AI_Output (self, other,"KDF_402_Corristo_KREIS2_Info_14_05"); //You know that you can use every rune as often as you like until you've used up your own powers.
...
FUNC void  KDF_402_Corristo_KREIS3_Info()
{
	...
	{
		AI_Output (self, other,"KDF_402_Corristo_KREIS3_Info_14_02"); //The Third Circle of Magic is one of the most important steps in the life of a magician. Once you have reached it, you cease to be a seeker.
		...
		AI_Output (self, other,"KDF_402_Corristo_KREIS3_Info_14_07"); //Understand your path, then you will recognize the power of the decision.
...
FUNC void  KDF_402_Corristo_KREIS4_Info()
{
	...
	{
		AI_Output (self, other,"KDF_402_Corristo_KREIS4_Info_14_02"); //You have completed the first three Circles. Now it is time for you to learn the secrets of magic.
		...
		AI_Output (self, other,"KDF_402_Corristo_KREIS4_Info_14_04"); //It is the same ore which is collected in the mines. This ore is endowed with magic formulas in the temples. There the runes are converted to the instruments of our power.
		...
		AI_Output (self, other,"KDF_402_Corristo_KREIS4_Info_14_07"); //Understand the magic, then you will discover the secret of power.
...
FUNC void  KDF_402_Corristo_HEAVYARMOR_Info()
{
	...
	if (Kapitel < 3) 
	{
		AI_Output (self, other,"KDF_402_Corristo_WANNBEKDF_Info_14_04"); //You are not yet ready. Come back when you've learned more.
