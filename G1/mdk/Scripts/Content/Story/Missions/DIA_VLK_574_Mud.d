...
{
	AI_Output (self, other,"DIA_Mud_FirstEXIT_07_00"); //Hey, man! New here? I haven't seen you here before.
...
{
	AI_Output (self, other,"DIA_Mud_Nerve_4_07_00"); //Is it possible that we're walking in circles? I mean, I don't know where you want to go...
	Npc_SetRefuseTalk(self, NerveSec);
	Mud_Nerve = 5;
	AI_StopProcessInfos	( self );
};
...
{
	AI_Output (self, other,"DIA_Mud_Nerve_8_07_00"); //There are some people who constantly try to beat me up. Horrible guys from the New Camp. Real cut-throats. The next time I'll tell them that, they will have to deal with you in future. Then they'll be dead scared.
	Npc_SetRefuseTalk(self, NerveSec);
	Mud_Nerve = 9;
	AI_StopProcessInfos	( self );
};
...
{
	AI_Output (self, other,"DIA_Mud_Nerve_12_07_00"); //You are my best friend here. The others only want to get rid of me all the time. I'm really grateful to you.
	Npc_SetRefuseTalk(self, NerveSec);
	Mud_Nerve = 13;
	AI_StopProcessInfos	( self );
};
...
{
	AI_Output (self, other,"DIA_Mud_Nerve_15_07_00"); //Where are you from? You must be happy that you have finally found somebody who understands you. I'm from Khorinis. Have you ever been there? Well, doesn't matter anyway.
	Npc_SetRefuseTalk(self, NerveSec);
	Mud_Nerve = 16;
	AI_StopProcessInfos	( self );
};
...
{
	AI_Output (self, other,"DIA_Mud_Nerve_18_07_00"); //Now that you are with me, we could show a few people where to go. These bastards have been harassing me for years. When I see one of them now, I'm gonna him a few things.
	Npc_SetRefuseTalk(self, NerveSec);
	Mud_Nerve = 19;
	AI_StopProcessInfos	( self );
};
...
{
	AI_Output (self, other,"DIA_Mud_Nerve_19_07_00"); //The two of us are a dream team. We could take over the Old Camp. The Ore Barons wouldn't be a problem for us since we are a team. I'll think of a plan.
	Npc_SetRefuseTalk(self, NerveSec);
	Mud_Nerve = 0;
	AI_StopProcessInfos	( self );
};
