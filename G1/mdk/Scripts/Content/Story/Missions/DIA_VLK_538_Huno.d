...
FUNC VOID DIA_Huno_HowLong_Info()
{
	...
	AI_Output (self,other,"DIA_Huno_HowLong_09_07"); //Hey, you aren't curious at all, are you, pal.
};
...
{
	AI_Output (other,self,"DIA_Huno_HowsYourBusiness_15_00"); //Well, smith, how's business?
...
FUNC VOID DIA_Huno_LEARNSMITH_Info()
{
	...
	AI_Output (self,other,"DIA_Huno_LEARNSMITH_09_05"); //When you are finished, you put the hot blade into the water bucket over there to temper it.
...
{
	AI_Output (other,self,"DIA_Huno_BUYSMITH_15_00"); //I'd like to buy blacksmith equipment!
