...
func void DIA_Grim_Falle_HalfHalf()
{
	...
	AI_Output (self, other,"DIA_Grim_Falle_HalfHalf_06_01"); //Okay, okay, fifty-fifty. I suppose it will be enough for the two of us anyway. So - can I count on you?
};
...
FUNC VOID DIA_Grim_HowFarAreYou_Info()
{
	...
	AI_Output (self, other,"DIA_Grim_HowFarAreYou_06_01"); //I've already talked to Dexter, Sly and Fingers. They are some of the most influential Shadows here in the Camp.
...
FUNC VOID  DIA_Grim_INEXTREMO_Info()
{
	...
	AI_Output		(self, other,"DIA_Grim_INEXTREMO_06_02"); //In Extremo are here. They are on stage over there.
