...
FUNC void  SLD_709_Cord_TRAIN_Info()
{
	...
	if (Npc_HasItems (hero,ItMiNugget) >= 30)
	{
		if B_GiveSkill(hero,NPC_TALENT_1H,1,LPCOST_TALENT_1H_1)
		{
			...
			AI_Output			(self,other,"SLD_709_Cord_TRAIN_14_04"); //You have to learn to harmonize your weapon's swing with your own movements. That'll make you faster in the attack.
	...
	{
		AI_Output (self, other,"KDF_402_Corristo_HEAVYARMOR_Info_14_03"); //You don't have enough ore!
	};
};  
/*------------------------------------------------------------------------
...
FUNC void  SLD_709_Cord_TRAINAGAIN_Info()
{
	...
	if (Npc_HasItems (hero,ItMiNugget) >= 50)
	{
		...
		{
			AI_Output		(self, other,"SLD_709_Cord_TRAINAGAIN_Info_14_02"); //Okay, you know the basics. Holding the weapon lower down will let you put more force into your first strike.
			AI_Output		(self, other,"SLD_709_Cord_TRAINAGAIN_Info_14_03"); //Use the swing, remember? Okay, now you need to use your body more. When you've struck twice, spin around. That'll confuse the opponent and put you in an excellent position.
