...
{
	AI_Output 		(hero, self,"Info_OrcShaman_TONGUE_15_01"); //How d'you know our language?
...
FUNC void  Info_OrcShaman_SLEEPER_Info()
{
	...
	AI_Output 		(hero, self,"Info_OrcShaman_SLEEPER_15_04"); //You mean five shamens!
	...
	AI_Output 		(hero, self,"Info_OrcShaman_SLEEPER_15_08"); //A subterranean temple for the Sleeper! That's what Xardas must have meant when he spoke about the entry being 'in the Orc town'!
}; 
