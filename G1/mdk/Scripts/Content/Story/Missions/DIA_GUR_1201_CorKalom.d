...
FUNC void  GUR_1201_CorKalom_BRINGWEED_Info()
{
	...
	{
		AI_Output			(self, other,"GUR_1201_CorKalom_BRINGWEED_10_01"); //And THAT's supposed to be the lot??? I expect the COMPLETE harvest, which means at least 100 stalks!!!
		AI_StopProcessInfos	(self);
	}
	else
	{
		AI_Output			(self, other,"GUR_1201_CorKalom_BRINGWEED_10_02"); //Ah, give it to me. And now get out of my sight!
