...
func VOID DIA_Gravo_Hallo_Info()
{
	...
	AI_Output (self, other,"DIA_Gravo_Hallo_04_01"); //Since I stopped working in the mine, I can't really complain.
...
func VOID DIA_Gravo_HelpHow_Info()
{
	...
	AI_Output (self, other,"DIA_Gravo_HelpHow_04_01"); //Well, let's assume you're in trouble with Thorus. You better never get into trouble with him, but then, you never know.
...
func void B_Gravo_HelpAttitude(var C_NPC prob)
{
	if (Npc_GetPermAttitude(prob, other)==ATT_ANGRY)
	{
		...
		{
			AI_Output (self, other,"B_Gravo_HelpAttitude_ANGRY_04_02"); //Let's see how much you have... Ah! That should be enough. You can consider the affair settled.
	...
	{
		AI_Output (self, other,"B_Gravo_HelpAttitude_HOSTILE_04_00"); //You call that trouble? That's an understatement. I think he would like to tear you into little peaces, boy.
		AI_Output (self, other,"B_Gravo_HelpAttitude_HOSTILE_04_01"); //It won't be cheap if I am to convince some people to calm him down again. It'll cost you 500 ore at least.
...
func VOID DIA_Gravo_HelpAngryNow_Info()
{
	...
	AI_Output (self, other,"DIA_Gravo_HelpAngryNow_04_01"); //I think so, but I warn you, my help could cost you between 100 and 500 ore.
