...
FUNC VOID  DIA_Balor_SellUnder_Info()
{
	...
	AI_Output (self, other,"DIA_Balor_SellUnder_01_01"); //Oh-oh! Now I've been putting ideas in your head, haven't I?
...
FUNC VOID  DIA_Balor_TellDealer_Info()
{
	...
	AI_Output (self, other,"DIA_Balor_TellDealer_01_02"); //I want to see 50 ore as an advance payment. Then we'll see.
...
func void DIA_Balor_TellDealer_Pay()
{
	...
	{
		AI_Output			(self, other,"DIA_Balor_TellDealer_Pay_01_01"); //Good... Listen. His name is Cipher. You'll probably find him in the bar on the lake.
...
FUNC VOID  DIA_Balor_RipOff_Info()
{
	...
	if (Balor_PlayerCheating == TRUE)
	{
		...
		AI_Output (self, other,"DIA_Balor_RipOff_01_02"); //I want to see 50 ore - my usual advance payment.
	}
	else
	{
