...
{	
	...
	AI_Output (self, other,"Info_Swiney_Schuerfer_09_01"); //Oh yeah? Just don't think you're going to get anything much out of it. There's three portions of rice a day, any extra you'll have to see to yourself.
	AI_Output (self, other,"Info_Swiney_Schuerfer_09_02"); //D'you know why we're doing this? We're doing this job so one day we can all walk out of here to freedom.
	...
	AI_Output (self, other,"Info_Swiney_Schuerfer_09_05"); //D'you at least have any experience on the job?
...
func void Info_Swiney_Schuerfer_Ja()
{
	...
	AI_Output (self, other,"Info_Swiney_Schuerfer_Ja_09_01"); //Good! Then you know what to watch out for. Here's your protective clothing. You'll have to find your own pickaxe. Enjoy yourself.
