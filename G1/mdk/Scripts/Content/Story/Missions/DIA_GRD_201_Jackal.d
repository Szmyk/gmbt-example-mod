...
{	
	...
	AI_Output (self, other,"Info_Jackal_Hello_07_02"); //I wanna offer you help. You're new here, an' new 'uns always get into trouble... You could save yourself a lot of that by makin' a small donation.
...
{	
	if	C_NpcBelongsToNewCamp(hero)
	{
		...
		||	(oldHeroGuild == GIL_STT)
		{
			...
			AI_Output		(self, other,"Info_Jackal_PAYDAY_07_02"); //You shouldn't have got involved with those losers, then you'd still be one of us!
		}
		else
		{
