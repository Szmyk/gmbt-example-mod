...
FUNC VOID  DIA_Joru_Greet_Info()
{
	...
	AI_Output (self, other,"DIA_Joru_Greet_07_03"); //I've even spoken to Y'Berion. He's the chosen one. He's told me that if I work hard, I can soon be a master myself.
...
FUNC VOID  DIA_Joru_SleeperContact_Info()
{
	...
	AI_Output (self, other,"DIA_Joru_SleeperContact_07_02"); //Kalom always wants to hear about the effect of it, but I get the impression that he's not really interested in my opinion at all.
...
FUNC VOID  DIA_Joru_ImpressGurus_Info()
{
	...
	AI_Output (self, other,"DIA_Joru_ImpressGurus_07_04"); //Baal Namib, over there at the main gate, is one of the toughest guys. I think Lester might be able to help you with him. Speak to him as soon as his master is away.
