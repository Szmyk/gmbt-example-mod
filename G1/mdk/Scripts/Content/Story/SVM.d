...

{
	...
	HandsOff					=	"SVM_1_HandsOff"					;//Hands off!
	...
	YouWannaFoolMe				=	"SVM_1_YouWannaFoolMe"				;//Do you think I'm stupid?
	...
	WhatDidYouInThere			=	"SVM_1_WhatDidYouInThere"			;//You've no business in there! Beat it!
	...
	NoLearnNoPoints				= 	"SVM_1_NoLearnNoPoints"				;//Come back as soon as youhave more experience.
	...
	YouStoleFromMe				=	"SVM_1_YouStoleFromMe"				;//You arsehole, you've stolen from me! Don't try that again!
	...
	YouKilledMage				=	"SVM_1_YouKilledMage"				;//You have killed a magician! How do you ever plan to justify that?
	...
	Smalltalk10					=	"SVM_1_Smalltalk10"					;// ... don't blather so much, yeah, yeah ...
...
instance SVM_2 (C_SVM)				// Misstrauisch
{
	...
	Help						=	"SVM_2_Help"						;//Ihave no time, got things to do!
	...
	YouWannaFoolMe				=	"SVM_2_YouWannaFoolMe"				;//It's not very clever of you to take me for a fool!
	...
	RunCoward					=	"SVM_2_RunCoward"					;//Stay here, you wimp!
	...
	SuckerDefeatedNov_Guard		= 	"SVM_2_SuckerDefeatedNov_Guard"		;//I make sure that there's order here!
	...
	YouStoleFromGur				=	"SVM_2_YouStoleFromGur"				;//You've stolen from the Gurus! You are lucky you didn't get caught!
	StoleFromMage				=	"SVM_2_StoleFromMage"				;//The magicians don't like people rummaging around in their stuff!
	YouKilledMyFriend			=	"SVM_2_YouKilledMyFriend"			;//You got one of our men on your conscience. Another little mistake and it'll be your turn!
	...
	YouKilledMage				=	"SVM_2_YouKilledMage"				;//You have killed a magician! How do you ever plan to justify that?
	...
	YouKilledPSIfolk			=	"SVM_2_YouKilledPSIfolk"			;//The brotherhood counts one believer less, and you got him on your conscience!
	...
	Smalltalk18					=	"SVM_2_Smalltalk18"					;// ... I'm not listening to all the blathering any more ...
	...
	Smalltalk22					=	"SVM_2_Smalltalk22"					;// ... hang on. Better not to go rushing into anything ...
...
instance SVM_3 (C_SVM)				 // Depressiv (Resigniert. Menschliches Gemüse. "Ich schau noch´n bisschen an die Decke.." , "Wir sind eh alle verloren..." Nov:Glauben an Drogen
{
	...
	DieMonster					=	"SVM_3_DieMonster"					;//You rotten beast won't disturb me any longer!
	...
	NeverTryThatAgain			=	"SVM_3_NeverTryThatAgain"			;//Don't every try anything like that again!
	...
	HeDefeatedHim				=	"SVM_3_HeDefeatedHim"				;//He has finished him off!
	...
	YouDefeatedMyComrade		=	"SVM_3_YouDefeatedMyComrade"		;//You've knocked down one of my mates!
	YouDefeatedNOV_Guard		=	"SVM_3_YouDefeatedNOV_Guard"		;//The novices are under my protection! Leave them alone!
	YouDefeatedVLK_Guard		=	"SVM_3_YouDefeatedVLK_Guard"		;//The diggers pay me so they don't have any trouble! I'll make sure it stays that way!
...
instance SVM_4 (C_SVM)				// Alter Sack,  (Torrez, KDF-Magier, alte Buddler....), alter Hase. Kann Grünschnäbeln noch was zeigen
{
	...
	ITookYourOre				=	"SVM_4_ITookYourOre"				;//I'll take better care of your ore than you have done!
	...
	NoLearnYoureBetter			=	"SVM_4_NoLearnYoureBetter"			;//You're already better than that already!
	...
	YouKilledMage				=	"SVM_4_YouKilledMage"				;//You have killed a magician! How do you ever plan to justify that?
	...
	YouKilledPSIfolk			=	"SVM_4_YouKilledPSIfolk"			;//The brotherhood counts one believer less, and you got him on your conscience!
...
instance SVM_5 (C_SVM)				//Lebenskünstler, offen, Fröhlich. humorvoller Verarscher. Auch: Fauler Verpisser. Selbstbewußt, wortgewandt, charismatisch. (Lester)
{
	...
	Smalltalk05					=	"SVM_5_Smalltalk05"					;// ... that's really not my problem ...
...
instance SVM_6 (C_SVM)				//Raufbold	(Will saufen und raufen	(Matrose) Alkoholiker. Grölt viel)
{
	...
	YouWannaFoolMe				=	"SVM_6_YouWannaFoolMe"				;//Yes, do you think I'm stupid?
	...
	CheerFight					=	"SVM_6_CheerFight"					;//You're fighthing like women!
	...
	LookingForTroubleAgain		=	"SVM_6_LookingForTroubleAgain"		;//You looking for trouble again?
	...
	SuckerDefeatedNov_Guard		= 	"SVM_6_SuckerDefeatedNov_Guard"		;//You can't run around here beating up the novices!
	...
	StoleFromMage				=	"SVM_6_StoleFromMage"				;//You have stolen from the magicians! A really lousy idea!
...
instance SVM_7 (C_SVM)				//Freak, Aggressiv. Spielt mit seiner Macht. Sadist. Org: Abschaum, den im AL keiner wollte. Nov (selten): Durchgeknallter Abschaum.
{
	...
	YouStillNotHaveEnough		=	"SVM_7_YouStillNotHaveEnough"		;//You don't want to try it again, do you?
	...
	DirtyThief					=	"SVM_7_DirtyThief"					;//You dirty thief! I want to see you suffer!
	YouAttackedMyCharge			=	"SVM_7_YouAttackedMyCharge"			;//Nobody beats up anybody else here except me!
	...
	CheerFight					=	"SVM_7_CheerFight"					;//I want to see blood!
	...
	SuckerDefeatedGur			=	"SVM_7_SuckerDefeatedGur"			;//You've knocked down a Guru. Somehow you seem to attract trouble like a magnet!
	...
	YouStoleFromMe				=	"SVM_7_YouStoleFromMe"				;//You arse have stolen from me! Don't try that again!
	...
	YouKilledMage				=	"SVM_7_YouKilledMage"				;//You have killed a magician! How do you ever plan to justify that?
	...
	Smalltalk05					=	"SVM_7_Smalltalk05"					;// ... that's really not my problem ...
	Smalltalk06					=	"SVM_7_Smalltalk06"					;// ... it was obvious that there would be trouble ahead ...
	...
	Smalltalk21					=	"SVM_7_Smalltalk21"					;// ... you're very probably right ...
	Smalltalk22					=	"SVM_7_Smalltalk22"					;// ... hang on. Better not to go rushing into anything ...
...
instance SVM_8 (C_SVM)				// Elite-Garde. Ultra-cool. Pflichtbewusst, ernst, nüchtern! Klare Stimme
{
	...
	WhatsThisSupposedToBe		=	"SVM_8_WhatsThisSupposedToBe"		;//Hey, you! What are you creeping around here for?
	...
	CheerFight					=	"SVM_8_CheerFight"					;//Yeas! Come on, come on!
	...
	YouKilledPSIfolk			=	"SVM_8_YouKilledPSIfolk"			;//The brotherhood counts one believer less, and you got him on your conscience!
	...
	Smalltalk07					=	"SVM_8_Smalltalk07"					;// ... but keep it to yourself, people don't need to know it.
...
instance SVM_9 (C_SVM)				// brummig		   gemütlicher Hüne, Besonnen, Brummiger Bär, Einfacher	Mensch
{
	...
	DieMonster					=	"SVM_9_DieMonster"					;//These beasts are really thick as mud!
	...
	WiseMove					=	"SVM_9_WiseMove"					;//Smart head!
	...
	CheerFight					=	"SVM_9_CheerFight"					;//Yeas! Come on, come on!
	...
	LookingForTroubleAgain		=	"SVM_9_LookingForTroubleAgain"		;//Looking for trouble again? Why d'you always pick on me?
	...
	YouDefeatedMyComrade		=	"SVM_9_YouDefeatedMyComrade"		;//You've knocked down my mate, what was that for?
	...
	YouKilledMage				=	"SVM_9_YouKilledMage"				;//You have killed a magician! How do you ever plan to justify that?
	...
	YouKilledPSIfolk			=	"SVM_9_YouKilledPSIfolk"			;//The brotherhood counts one believer less, and you got him on your conscience!
...
instance SVM_10	(C_SVM)				// Schlau, verschlagen,	heimlich, Zwielichtig, zynisch,	intrigant Dealer (RAVEN, KALOM)
{
	...
	WatchYourAimAngry			=	"SVM_10_WatchYourAimAngry"				;//If you want trouble, just carry on aiming at me!
	...
	YesYes						=	"SVM_10_YesYes"							;//Yes, yes! Don't panic! You've won.
	...
	WhatsThisSupposedToBe		=	"SVM_10_WhatsThisSupposedToBe"			;//Hey, you! What are you creeping about here for?
	...
	YouStoleFromMe				=	"SVM_10_YouStoleFromMe"					;//Don't try that again, you thief!
	...
	YouKilledMyFriend			=	"SVM_10_YouKilledMyFriend"				;//You got one of our men on your conscience. Another little mistake and it'll be your turn!
	...
	Smalltalk18					=	"SVM_10_Smalltalk18"					;// ... I'm not listening to all the blathering any more ...
	...
	Smalltalk21					=	"SVM_10_Smalltalk21"					;// ... you're very probably right ...
...
instance SVM_11	(C_SVM)				//Profi				Ruhig, abgezockt, Vernünftig aberknallhart
{
	...
	WatchYourAimAngry			=	"SVM_11_WatchYourAimAngry"				;//So you want to get in trouble with me? Are you sure?
	...
	Strange						=	"SVM_11_Strange"						;//Mmh! Damn! Where'd he get to?
	...
	LookAway					=	"SVM_11_LookAway"						;//I'm not going to get involved in this!
	...
	YouStoleFromUs				=	"SVM_11_YouStoleFromUs"					;//You got some stuff that belongs to us. You better give it back.
	...
	Smalltalk14					=	"SVM_11_Smalltalk14"					;// ... same old story every time …I
	Smalltalk15					=	"SVM_11_Smalltalk15"					;// ... some people never learn ...
	Smalltalk16					=	"SVM_11_Smalltalk16"					;// ... there was a time when things would have gone very differently ...
...
instance SVM_12	(C_SVM)		//Bazaar-Händler		Nach außen freundlich,jovial,Innen hinterhältig, raffgierig
{
	...
	YouAskedForIt				=	"SVM_12_YouAskedForIt"					;//Okay, you've asked for it!
	...
	YouKilledMyFriend			=	"SVM_12_YouKilledMyFriend"				;//You got one of our men on your conscience. Another little mistake and it'll be your turn!
...
instance SVM_13	(C_SVM)					// Fanatiker	Agressiv, übereifrig, Ähnlich wie Stimme7Freak,	aber klarer, Ruhm-und-Ehre-Typ,	Nov: Glauben an	Y´berion blind,	Mitläufer
{
	...
	HeyHeyHey					=	"SVM_13_HeyHeyHey"						;//Yes, again!
	...
	StoleFromMage				=	"SVM_13_StoleFromMage"					;//You have stolen from the magicians! A really lousy idea!
	...
	YouKilledMage				=	"SVM_13_YouKilledMage"					;//You have killed a magician! How do you ever plan to justify that?
	...
	Smalltalk06					=	"SVM_13_Smalltalk06"					;// ... it was obvious that there would be trouble ahead ...
...
instance SVM_14	(C_SVM)				// Xardas(DMB),Corristo,Erzähler	alt	arrogant, gebildet
{
	...
	ISaidWeaponDown				=	"SVM_14_ISaidWeaponDown"				;//Put your weapon down!
	...
	Strange						=	"SVM_14_Strange"						;//A good trick, he has just disappeared!
	...
	NoLearnYouAlreadyKnow		=	"SVM_14_NoLearnYouAlreadyKnow"			;//You need to become advanced before you can become a master!
	...
	YouCanKeeptheCrap			=	"SVM_14_YouCanKeeptheCrap"				;//Okay. I don't want it any more!
	...
	YouStoleFromUs				=	"SVM_14_YouStoleFromUs"					;//You got some stuff that belongs to us. You better give it back.
	...
	YouKilledMage				=	"SVM_14_YouKilledMage"					;//You have killed a magician! How do you ever plan to justify that?
	...
	Smalltalk06					=	"SVM_14_Smalltalk06"					;// ... it was obvious that there would be trouble ahead ...
	...
	Smalltalk16					=	"SVM_14_Smalltalk16"					;// ... there was a time when things would have gone very differently ...
	...
	Smalltalk20					=	"SVM_14_Smalltalk20"					;// ... I doubt that's ever likely to change ...
	Smalltalk21					=	"SVM_14_Smalltalk21"					;// ... you're very probably right ...
	Smalltalk22					=	"SVM_14_Smalltalk22"					;// ... hang on. Better not to go rushing into anything ...
	Smalltalk23					=	"SVM_14_Smalltalk23"					;// ... I thought that had been cleared ages ago ...
