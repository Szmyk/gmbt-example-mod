...
FUNC VOID Info_FindNPC_NC_Gorn()
{
	...
	else
	{
		if (self.guild == GIL_ORG)
		{
			...
			{
				AI_Output(self,other,"Info_FindNPC_NC_Gorn_07_01"); //When you go in the cave, keep to your right. There are a couple of huts right in the front. He lives in one of them.
			}
