...
FUNC VOID Info_Vlk_1_EinerVonEuchWerden_Info()
{
	...
	AI_Output(self,other,"Info_Vlk_1_EinerVonEuchWerden_01_01"); //That's simple. Grab a pickaxe and get in the mine. Half of your ore gets spent for protection, the rest will just about enable you to survive.
...
FUNC VOID Info_Vlk_1_WichtigePersonen_Info()
{
	...
	AI_Output(self,other,"Info_Vlk_1_WichtigePersonen_01_01"); //The Ore Barons. The organize the exchange of ore with the King. The more important you are, the more you get.
};
...
FUNC VOID Info_Vlk_1_DieLage_Info()
{
	...
	AI_Output(self,other,"Info_Vlk_1_DieLage_01_01"); //I've spent the last two weeks working in the mine. All I want is peace. So get out of my sight.
};
