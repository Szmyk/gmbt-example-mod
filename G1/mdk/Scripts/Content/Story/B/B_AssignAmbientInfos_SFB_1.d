...
FUNC VOID Info_SFB_1_EinerVonEuchWerden_Info()
{
	...
	AI_Output(self,other,"Info_SFB_1_EinerVonEuchWerden_01_01"); //Join us? Now don't you go thinkin' we don't work around here, just because no-one forces us to.
	AI_Output(self,other,"Info_SFB_1_EinerVonEuchWerden_01_02"); //If you think you can just laze around here, then you have another thing coming, my friend.
...
FUNC VOID Info_SFB_1_WichtigePersonen_Info()
{
	...
	AI_Output(self,other,"Info_SFB_1_WichtigePersonen_01_01"); //In charge? Take a look round. It's not the one's that spend all day working their butts off to collect ore, that's for sure.
};
